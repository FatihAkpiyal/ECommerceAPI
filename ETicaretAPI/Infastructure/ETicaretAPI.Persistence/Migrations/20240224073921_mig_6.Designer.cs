...
namespace ETicaretAPI.Persistence.Migrations
{
    ...
    [Migration("20240224073921_mig_6")]
    partial class mig_6
    {
            ...
            modelBuilder.Entity("ProductProductImageFile", b =>
                {
                    ...
                    b.Property<Guid>("ProductImageFilesId1")
                        .HasColumnType("uuid");

                    b.HasKey("ProductImageFilesId", "ProductImageFilesId1");

                    b.HasIndex("ProductImageFilesId1");
            ...
            modelBuilder.Entity("ProductProductImageFile", b =>
                {
                    ...
                    b.HasOne("ETicaretAPI.Domain.Entities.Product", null)
                        .WithMany()
                        .HasForeignKey("ProductImageFilesId1")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
